...
- Added non-destructive local checkout repair for stale root `src/`/`utils/`, a compatibility IDL re-export for older checkouts, a workspace doctor, and migration documentation. Metaplex dependency pins remain current and centralized. Version remains 1.0.0.
