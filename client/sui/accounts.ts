...
export function wpwrcCoinType(packageId: string): string {
...
export async function listWpwrcCoinObjects(
  client: ClientWithCoreApi,
  input: {
    owner: string;
    coinType: string;
...
export async function assertWpwrcCoinMetadata(
  client: ClientWithCoreApi,
  coinType: string,
): Promise<void> {
