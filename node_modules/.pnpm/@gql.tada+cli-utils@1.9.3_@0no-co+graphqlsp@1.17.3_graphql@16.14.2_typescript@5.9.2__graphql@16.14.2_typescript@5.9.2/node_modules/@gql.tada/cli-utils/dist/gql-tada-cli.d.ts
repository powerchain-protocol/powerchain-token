 ...
 */
declare function scan(opts: ScanOptions): Promise<void>;
...
declare const api_scan: typeof scan;
...
export { main as default, generateOutput, generatePersisted, generateSchema, generateTurbo, scan };
