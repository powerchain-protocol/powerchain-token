...
var V = "undefined" != typeof require ? require.resolve.bind(require) : h(import.meta.url).resolve;

var resolveExtend = async (e, r) => {
  try {
    return toTSConfigPath(V(e, {
      paths: [ r ]
    }));
  } catch (e) {
    return null;
...
var j = [ "/* eslint-disable */", "/* prettier-ignore */" ].join("\n") + "\n";
...
function outputIntrospectionFile(e, r) {
  ...
  if (/\.d\.ts$/.test(r.fileType)) {
    ...
    if ("string" != typeof e && r.shouldPreprocess) {
      n.push(`export type ${B} = ${preprocessIntrospectionTypes(e)};\n`, U, `export type introspection = ${preprocessIntrospection(e, B)};\n`, "import * as gqlTada from 'gql.tada';\n");
    } else {
      n.push(U, `export type introspection = ${stringifyJson(e)};\n`, "import * as gqlTada from 'gql.tada';\n");
    }
    if (!("name" in e) || !e.name) {
