...
import * as _mysten_bcs1356 from "@mysten/bcs";
...
declare class Transaction {
  ...
  getData(): {
    ...
    expiration?: _mysten_bcs1356.EnumOutputShapeWithKeys<{
      None: true;
      Epoch: string | number;
      ValidDuring: {
    ...
    inputs: _mysten_bcs1356.EnumOutputShapeWithKeys<{
      Object: _mysten_bcs1356.EnumOutputShapeWithKeys<{
        ImmOrOwnedObject: {
          objectId: string;
          version: string | number;
          digest: string;
      ...
      FundsWithdrawal: {
        ...
        withdrawFrom: _mysten_bcs1356.EnumOutputShapeWithKeys<{
          Sender: true;
          Sponsor: true;
        }, "Sender" | "Sponsor">;
      };
    }, "Pure" | "Object" | "FundsWithdrawal" | "UnresolvedPure" | "UnresolvedObject">[];
    commands: _mysten_bcs1356.EnumOutputShapeWithKeys<{
      MoveCall: {
        package: string;
        module: string;
        function: string;
