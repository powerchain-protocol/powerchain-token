...
export function parsePwrcAmount(
  value: string,
): bigint {
...
export function formatPwrcAmount(
  baseUnits: bigint,
  options?: {
...
export function assertPwrcBaseUnits(
  baseUnits: bigint,
): bigint {
  if (
    baseUnits < 0n ||
