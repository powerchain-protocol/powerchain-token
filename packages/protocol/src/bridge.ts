...
export const WPWRC_WRAPPED_DECIMALS = 9 as const;
export const PWRC_BASE_UNITS_PER_WPWRC_BASE_UNIT = 1n as const;
export const WPWRC_MAX_BASE_UNITS = PWRC_MAX_BASE_UNITS;

export const PWRC_BRIDGE_TRANSFER_FEE_BPS =
  PWRC_TRANSFER_FEE_BPS;
export const PWRC_BRIDGE_MAX_TRANSFER_FEE_TOKENS =
  PWRC_MAX_TRANSFER_FEE_TOKENS;
...
export function assertBridgeIdentity(identity: PWRCBridgeIdentity): void {
  ...
  if (
    identity.wrapped.coinType !== null &&
    identity.wrapped.packageId !== null &&
