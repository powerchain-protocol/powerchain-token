...
if (!fs.existsSync(file)) {
  ...
  if (manifest) {
    ...
    for (const required of [
      ...
      "tests/token-description-source.test.mjs",
      "scripts/production/check-token-description.mjs",
      "apps/api/lib/token-description.mjs",
  ...
  "scripts/production/check-api-cache.mjs",
      ...
      "docs/TOKEN.md",
      "tests/utility-wallet-authorization-source.test.mjs",
      "scripts/production/check-utility-wallet-authorization.mjs",
      "packages/sdk/src/utility.ts",
      "packages/sdk/src/native-token-transactions.ts",
      "tests/native-transfer-preflight-source.test.mjs",
      ...
      "tests/native-transfer-review-bundle-source.test.mjs",
      "tests/native-verified-transfer-intent-source.test.mjs",
      ...
      "docs/HELIUS.md",
      ".env.example",
      "tests/helius-client-hardening-source.test.mjs",
      ...
      "tests/client-ui-source.test.mjs",
      "scripts/production/check-client-ui.mjs",
      "apps/client/package.json",
      "tests/client-uiux-source.test.mjs",
