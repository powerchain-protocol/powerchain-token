...
export const PWRC_MARKET_POLICY_VERSION = "1.0.0" as const;
...
export const PWRC_TRADEABILITY_POLICY: PwrcTradeabilityPolicy = {
...
export function assertNonZeroPwrcAmount(
...
export function uiToBaseUnits(uiAmount: string): bigint {
...
export function baseUnitsToUi(amountBaseUnits: bigint): string {
  if (amountBaseUnits < 0n) throw new Error("PWRC_AMOUNT_NEGATIVE");
