import test from "node:test"; import assert from "node:assert/strict"; import {canonicalToWrappedExact,wrappedToCanonical} from "../packages/protocol/src/common/token-units.js";
